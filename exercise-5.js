...
var word = 'wow JavaScript is so cool';
var exampleFirstWord = word[0] + word[1] + word[2];
var secondWord = word[4] + word[5] + word[6] + word [7] + word[9] + word[10] + word[11] + word [12] + word[13];  // do your own!
...
console.log('Third Word: ' + thirdWord4 + ', with length: ' + fourthWordLength4);
console.log('Fourth Word: ' + fourthWord4 + ', with length: ' + thirdWordLength4);
